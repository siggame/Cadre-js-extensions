...
var mathExtensions = {
    ...
    /**
     * Generates a range of numbers [a - b]
     *
     * @param {number} a - the min or max of the range
     * @param {number} b - the min or max of the range
     * @returns {Array.<number>} the numbers generated in a range
     */
    range: function(a, b) {
        a = a || 0;
        b = b || 0;
...
for(var extension in mathExtensions) {
    if(!Math.hasOwnProperty(extension)) {
