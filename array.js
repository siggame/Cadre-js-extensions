...
var arrayExtensions = {
     ...
     *
     * @param {number} [offset = 0] - 0 to length-1, being how far from the back to get from. e.g. in [a, b, c, d, e], last(1) would be d (last - 1).
...
for(var extension in arrayExtensions) {
    if(!Array.prototype.hasOwnProperty(extension)) {
